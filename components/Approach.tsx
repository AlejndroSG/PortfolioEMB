  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        {t("approach.title")}{" "}
        <span className="text-purple">{t("approach.subtitle")}</span>
      </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
          title={t("approach.phase1.title")} 
          icon={<AceternityIcon order={t("approach.phase1.phase")} />}
          description={t("approach.phase1.description")}
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
          title={t("approach.phase2.title")} 
          icon={<AceternityIcon order={t("approach.phase2.phase")} />}
          description={t("approach.phase2.description")}
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
          title={t("approach.phase3.title")} 
          icon={<AceternityIcon order={t("approach.phase3.phase")} />}
          description={t("approach.phase3.description")}
        >
          <CanvasRevealEffect
            animationSpeed={3}
