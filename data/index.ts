...
export const projects = [
  {
    id: 1,
    titleKey: "projects.items.peakyBlinders.title",
    title: "Peaky Blinders",
    desKey: "projects.items.peakyBlinders.description",
    ...
    clientKey: "projects.items.peakyBlinders.client",
    client: "BBC Entertainment",
    year: "2023",
    categoryKey: "projects.items.peakyBlinders.category",
    category: "Entretenimiento",
    challengeKey: "projects.items.peakyBlinders.challenge",
    ...
    solutionKey: "projects.items.peakyBlinders.solution",
  ...
  {
    id: 2,
    titleKey: "projects.items.dunkinDonuts.title",
    title: "Dunkin Donuts",
    desKey: "projects.items.dunkinDonuts.description",
    ...
    clientKey: "projects.items.dunkinDonuts.client",
    client: "Dunkin Brands International",
    year: "2024",
    categoryKey: "projects.items.dunkinDonuts.category",
    category: "E-commerce / Alimentación",
    challengeKey: "projects.items.dunkinDonuts.challenge",
    ...
    solutionKey: "projects.items.dunkinDonuts.solution",
  ...
  {
    id: 3,
    titleKey: "projects.items.learnIA.title",
    title: "Learn IA",
    desKey: "projects.items.learnIA.description",
    ...
    link: "https://github.com/agchdev/PeakyBlinders",
    clientKey: "projects.items.learnIA.client",
    client: "Instituto Tecnológico de Educación Digital",
    year: "2023",
    categoryKey: "projects.items.learnIA.category",
    category: "Educación / Tecnología",
    challengeKey: "projects.items.learnIA.challenge",
    ...
    solutionKey: "projects.items.learnIA.solution",
  ...
  {
    id: 4,
    titleKey: "projects.items.iphone.title",
    title: "Sitio Web 3D Animado de Apple iPhone",
    desKey: "projects.items.iphone.description",
    ...
    link: "/ui.apple.com",
    clientKey: "projects.items.iphone.client",
    client: "Apple Inc. (Proyecto de demostración)",
    year: "2024",
    categoryKey: "projects.items.iphone.category",
    category: "Tecnología / Showcase",
    challengeKey: "projects.items.iphone.challenge",
    ...
    solutionKey: "projects.items.iphone.solution",
